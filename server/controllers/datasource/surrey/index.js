...
var debug = require('debug')('lc:surrey');

// Data model
var mongoose = require('mongoose');

// Get the model schema used by this controller
var Permit = mongoose.model('SurreyPermit');
...
exports.update = function(req, res, next) {
    ...
    Permit.findById(req.params.surrey_id, function(err, permit) {
        // handle any errors
        if(err) {
            return next(err);
        }
...
exports.show = function(req, res, next) {
    ...
    var criteria = {};
    criteria[key] = req.params.surrey_id;
